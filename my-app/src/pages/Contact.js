        ...
        <div className="allContact">
          ...
          <div className="form">
            ...
            <form className="formMain" ref={form} onSubmit={handleSubmit}>
              <div>
                <label htmlFor="name" className="nameL">
                  {english ? "Name:" : "Nome:"}
                </label>
                <input
                  className="name"
                  placeholder={english?"Enter your name" : "Digite seu Nome"}
                  type="text"
                  name="name"
                  value={name}
              ...
              <div>
                <label className="emailL" htmlFor="email">
                  Email:
                </label>
                <input
                  className="email"
                  placeholder={english?"Enter your email" : "Digite seu email"}
                  type="email"
                  name="email"
                  value={email}
                  onChange={handleInputChange}
              ...
              <div>
                <div className="textfield">
                  <label className="messageL" htmlFor="message">
          ...
          <main className="contact">
            <div className="textC">
              ...
              <a
                href="https://www.linkedin.com/in/hebertt-nascimento/"
                target="_blank"
                rel="noreferrer"
              >
                {" "}
